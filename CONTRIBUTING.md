...
### Fork, Clone and switch to the `develop` branch:

1. Fork the repository on GitHub.
2. Clone your fork locally and navigate into the project directory:
```bash
git clone https://github.com/username/m-sdk-be.git
cd m-sdk-be
...
```bash
git remote add upstream https://github.com/tetherto/m-sdk-be.git
```
